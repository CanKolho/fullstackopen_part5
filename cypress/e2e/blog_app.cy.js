describe('Blog app', function() {
  ...
  describe('When logged in', function() {
    ...
    it('A blog can be created', function() {
      ...
      cy.get('.success')
        .should('contain', "a new blog 'some blog about something' by blogger added") 
    ...
    it('A blog can be liked', function() {
      ...
      cy.contains('likes are important - tester').parent().find('button').as('view-btn')
    ...
    it('Only the user that has added the blog can see `remove`-button', function() {
      cy.createBlog({ title: 'can you see me', author: 'tester', url: 'www.canyouseeme.com' })

      cy.contains('can you see me - tester').parent().find('button').as('view-btn')
      cy.get('@view-btn').click()
    ...
    it('Blogs are ordered by likes in descending order', function() {
      cy.createBlog({ title: 'first blog', author: 'first', url: 'www.first.com' })
      cy.createBlog({ title: 'second blog', author: 'second', url: 'www.second.com' })
      cy.createBlog({ title: 'third blog', author: 'third', url: 'www.third.com' })
      ...
      cy.contains('Likes 0').parent().find('button')
        .click()
        .wait(500)
        .click()
